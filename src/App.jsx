...
const articles = [
  ['actualite-16', 'Mission de contrôle financier évalue les activités du projet PINUT-DPE', '/assets/img/pinutdep.jpg', '23 Juillet 2026', 'Du 30 juin au 4 juillet 2026, la région du Tonkpi a accueilli une mission de contrôle conduite par la Direction du Contrôle financier dans le cadre de l"'"exécution des conventions des Agents d'Encadrement Local (AEL) et du suivi des travaux de construction des FRANCs du projet PINUT-DPE.'],
